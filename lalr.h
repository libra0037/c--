...
constexpr const char ac1[] = {ALLOC, 9, ENDF, 2, FREE, 10, GETC, 7, ID, 4, IF, 5, INT, 3, LPARE, 11, PUTC, 8, WHILE, 6, Default, -1};
constexpr const char ac22[] = {ALLOC, 9, FREE, 10, GETC, 7, ID, 4, IF, 5, INT, 3, LPARE, 11, PUTC, 8, SEMI, 55, WHILE, 6, Default, -1};
constexpr const char ac5[] = {ALLOC, 9, FREE, 10, GETC, 7, ID, 4, INT, 3, LPARE, 11, PUTC, 8, Default, -1};
constexpr const char ac7[] = {ALLOC, 9, FREE, 10, GETC, 7, ID, 19, INT, 3, LPARE, 11, PUTC, 8, Default, -1};
...
constexpr const char ac34[] = {RBRAC, 57, Default, -1};
constexpr const char ac36[] = {RBRAC, 59, Default, -1};
constexpr const char ac17[] = {RPARE, 42, Default, -1};
constexpr const char ac8[] = {SEMI, 25, Default, -1};
constexpr const char ac11[] = {SEMI, 38, Default, -1};
